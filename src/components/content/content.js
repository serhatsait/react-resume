                        ...
                        <div className="wrapper">
                            ...
                            >
                                <div
                                    ...
                                    data-parallax="true"
                                    style={{background: 'url("images/cc-bg-1.jpg")'}}
                                ></div>
                            ...
                            >
                                <div className="card-body">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-6">
                                            <div className="progress-container progress-primary">
                                                <span className="progress-badge">Laravel</span>
                                                <div className="progress">
                                                    <div
                                                        className="progress-bar progress-bar-primary"
                                                        data-aos="progress-full"
                        ...
                        <div className="container cc-education">
                                ...
                                <div className="row">
                                    ...
                                    >
                                        <div className="card-body cc-education-header">
                                            <p>2018 - 2020</p>
                                            <div className="h5">Associate Degree</div>
                                        </div>
                                    </div>
                                    <div
                                        className="col-md-9"
                                    ...
                                    >
                                        <div className="card-body">
                                            ...
                                            <p className="category">University of Nişantası</p>
                                            <p>
                                                Euismod massa scelerisque suspendisse fermentum habitant
                                                vitae ullamcorper magna quam iaculis, tristique sapien
                                                taciti mollis interdum sagittis libero nunc inceptos
                            ...
                            <div className="card">
                                <div className="row">
                                    ...
                                    >
                                        <div className="card-body">
                                            <div className="h5">Faculty of Science and Letters</div>
                                            <p className="category">University of Gaziosmanpaşa</p>
                                            <p>
                                                Euismod massa scelerisque suspendisse fermentum habitant
                                                vitae ullamcorper magna quam iaculis, tristique sapien
                                                taciti mollis interdum sagittis libero nunc inceptos
